<?php 
	$hook_array['before_save'][] = array(
		...
		"custom/modules/tc_dev/update_project_values_dev.php", //exact path and file name where custom code resides
		"update_project_values_dev", //Name of the class of custom code. It must be same as file name
		"update_method_dev", // name of the method inside custom class that will be fired when the hook fires.
	);
	  $hook_array['before_save'][] = array(
		2,
	...
	$hook_array['before_delete'][] = array(
		...
		"custom/modules/tc_dev/update_project_values_dev.php", //exact path and file name where custom code resides
		"update_project_values_dev", //Name of the class of custom code. It must be same as file name
		"delete_method_dev", // name of the method inside custom class that will be fired when the hook fires.
	);
?>