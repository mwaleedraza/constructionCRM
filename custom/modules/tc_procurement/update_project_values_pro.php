...
class update_project_value_pro{
	public function update_method_pro($bean, $event, $arguments){
		...
		if (!isset($bean->fetched_row['id'])) { //New record
			...
			$bean->name=$bean->contacts_name_c5;
	...
	public function delete_method_pro($bean, $event, $arguments){
