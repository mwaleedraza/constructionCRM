	...
	$duedate=date('Y-m-d h:i:s', strtotime($currentDateTimeDB) - date('Z'));
		...
		if (!isset($bean->fetched_row['id'])) {
	      ...
	      if(empty($procList)){
		    ...
		    '$bean->contacts_name_c1','$bean->contacts_name_c2','$bean->contacts_name_c3','$bean->contacts_id_c4','$bean->contacts_name_c4',0,'$bean->id','$bean->contacts_id_c5','$bean->contacts_name_c5','$bean->name_c'
		)";
