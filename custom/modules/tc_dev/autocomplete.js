$(document).ready(function(){
	...
	$("<p id='unit_price_d'></p>").insertAfter("#unit_price");
	$("<p id='amount_paid_d'></p>").insertAfter("#amount_paid");
    ...
    $('#amount_c3,#amount_c1,#amount_c2,#unit_price,#amount_paid').each(function(){
    $(this).keyup(function(){
    var value = $(this).val();
